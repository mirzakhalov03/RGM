        ...
        <div className='container relative'>
            <div className="w-full flex items-center min-h-screen justify-around">
                <div data-aos="fade-up" className='heroWrapperMob flex flex-col'>
                    <span className='strongOnMob flex gap-2 items-center justify-center md:justify-normal'>
                    ...
                    <div className='w-full flex md:justify-start justify-center  mt-[12px] gap-4'>
                      <button onClick={()=>{navigate("/lineup")}} className='heroBtn1' >{t("heroBtn1")}</button>
                      <a target='_blank' href='https://t.me/rgm_clinic' className='px-3 py-1 bg-[#ffffffcc] rounded-lg border-2 border-sky-400 text-[--headline] flex items-center gap-1'><img className='w-[20px] h-[20px]' src={telegramLogo} alt="" /><span>Telegram</span></a>
                    </div>
                </div>
